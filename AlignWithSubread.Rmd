...
cd /home/users/allstaff/quaglieri.a/PHD_project/MiltonMyFriend/Subread_Example/example_bamfiles
...
fastqdir=/home/users/allstaff/quaglieri.a/PHD_project/MiltonMyFriend/Subread_Example/example_bamfiles
...
for fastq in ${fastqdir}/*fastq.gz ; do 
  ...
  echo '#PBS -l nodes=1:ppn=10,mem=4gb' >> ${scriptdir}/${sampleName}_fastq.sh # >> same as cat(append=TRUE)
...
setwd(file.path("Subread_Example/Subread_index"))
list.files()
```
...
index_directory <- file.path(repo_dir,"MiltonMyFriend/Subread_Example/Subread_index")
...
align(index='hg19_index',
      readfile1='/home/users/allstaff/quaglieri.a/PHD_project/MiltonMyFriend/Subread_Example/example_bamfiles/SRX381851_R1.fastq.gz',
